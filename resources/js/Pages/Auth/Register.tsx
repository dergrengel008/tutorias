            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-xl shadow-gray-200/50">
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="new-password"
                                    required
                                    className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 pl-11 pr-4 text-sm text-gray-900 placeholder-gray-400 transition-colors focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
                        ...
                        {errors.terms && (
                            <p className="-mt-3 text-sm text-red-600">{errors.terms}</p>
                        )}
